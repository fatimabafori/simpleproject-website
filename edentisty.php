...
<body>
    ...
    <div class="image-container">
        <div class="image-frame">
            <img src="img/II (2).jpg" width="498" height="602" alt="rr">
            <!-- رابط للانتقال إلى موقع التحميل عند النقر -->
        ...
        <div class="image-frame">
            <img src="img/KK.jpg" width="540" height="960" alt="hh">
            <!-- رابط للانتقال إلى موقع التحميل عند النقر -->
            <a href="https://noor-book.com/fnp6wo" class="download-btn" target="_blank">تحميل</a>
        </div>
        <div class="image-frame">
            <img src="img/OO (2).jpg" width="310" height="543" alt="dd">
            <!-- رابط للانتقال إلى موقع التحميل عند النقر -->
